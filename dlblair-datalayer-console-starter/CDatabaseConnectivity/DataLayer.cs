...
namespace edu.northeaststate.dlblair.cDatabaseConnectivity
{
    ...
    internal class DataLayer
    {
        ...
        /// <returns></returns>
        /// <exception cref="Exception"></exception>
        public async Task<int>? DeleteAnArticleAsync(Article? article)
        {
    ...
    /// <exception cref="Exception"></exception>
        public async Task<int>? PostANewRatingAsync(Rating? rating)
            ...
            try
            {
                ...
                // add parameters to command, which will be passed to the stored procedure
                cmd.Parameters.Add(new MySqlParameter("artID", rating.ArticleID));
        ...
        public async Task<int>? PutARatingAsync(Rating? rating)
            ...
            try
            {
                ...
                cmd.Parameters.Add(new MySqlParameter("artID", rating.ArticleID));
                cmd.Parameters.Add(new MySqlParameter("uID", rating.UserID));
                cmd.Parameters.Add(new MySqlParameter("articleRating", rating.UserRating));
